...
(function () {
  ...
  var SERIES = {
    ...
    'maths/seconde': {
      ...
      types: { lecon: 'Cours', exercices: 'Exercices', ds: 'Devoir surveillé', fiche: 'Fiche résumé', qcm: 'QCM', interro: 'Interrogation' },
      chapters: [
    ...
    'maths/bts': {
      ...
      summaryLabel: 'BTS',
      subject:      'Mathématiques',
      types: { lecon: 'Cours', exercices: 'Exercices', ds: 'Devoir surveillé', qcm: 'QCM', interro: 'Interrogation' },
      chapters: [
  ...
  var OPTIONAL_TYPES = { qcm: true, interro: true };
