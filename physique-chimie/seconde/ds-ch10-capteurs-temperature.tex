...
\begin{itemize}[leftmargin=*,itemsep=1pt,topsep=2pt]
  ...
  \item \textbf{Valeur intermédiaire par proportionnalité :} entre deux points d'un tableau, on calcule le \textbf{coefficient multiplicateur}
        \[ k = \dfrac{\text{variation partielle}}{\text{variation totale}} \]
        puis on l'applique à l'intervalle de température : $\Delta\theta = k\times (\theta_2 - \theta_1)$.
\end{itemize}
\end{rappel}
...
\item Pendant un cycle de séchage, on mesure une résistance $R = 3\,500\ \Omega$. Cette valeur ne figure pas dans le tableau : elle est comprise entre $R_1 = 5\,000\ \Omega$ (à $\theta_1 = 40\ ^\circ$C) et $R_2 = 2\,000\ \Omega$ (à $\theta_2 = 60\ ^\circ$C).\par
\vspace{4pt}
\textbf{a.} Calculer la variation totale de résistance $\Delta R_{\text{tot}} = R_1 - R_2$ entre $40\ ^\circ$C et $60\ ^\circ$C. \pt{0,5}

\vspace{1.2cm}

\textbf{b.} Calculer la variation partielle $\Delta R = R_1 - R$ (de $R_1 = 5\,000\ \Omega$ jusqu'à la valeur mesurée). \pt{0,5}

\vspace{1.2cm}

\textbf{c.} En déduire le \textbf{coefficient multiplicateur} $k = \dfrac{\Delta R}{\Delta R_{\text{tot}}}$. \pt{1}

\vspace{1.2cm}

\textbf{d.} Calculer la variation de température $\Delta\theta = k \times (\theta_2 - \theta_1)$, puis en déduire la température mesurée $\theta = \theta_1 + \Delta\theta$. \pt{1,5}
