...
\medskip
\textbf{Simulation numérique disponible sur ordinateur ou tablette :}\\
\texttt{https://maths-sciences-lp.github.io/simulations/debit-fluide.html}\\
\textit{Utilisez la simulation pour vérifier vos calculs et répondre à la question Q5.}
\end{contextebox}
...
\textbf{Q5} \comp{VAL} — \textbf{À l'aide de la simulation numérique :}
\begin{enumerate}[nosep, label=\alph*)]
  \item Vérifier vos résultats de Q3 et Q4 en réglant les curseurs sur $Q_v = 1{,}8$ m³/h, $d_1 = 40$ mm et $d_2 = 25$ mm. Les vitesses affichées confirment-elles vos calculs ?
  \item La vitesse $v_1$ respecte-t-elle la norme (0,5 à 1,5 m/s) ? Si non, utilisez la simulation pour trouver un diamètre $d_1$ qui donne une vitesse conforme. Noter la valeur trouvée.
\end{enumerate}
\pts{1 pt}

\begin{reponsebox}[4cm]
a) Vérification : $v_1$ simulation = \dotfill \quad $v_2$ simulation = \dotfill

\dotfill

b) Diamètre $d_1$ corrigé = \dotfill mm \quad $\to$ vitesse $v_1$ = \dotfill m/s
